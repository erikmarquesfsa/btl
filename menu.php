...
$login = 'ecarmo';
  ...
  /*if($login==""){
    ...
    alert('Ops! Tivemos um erro interno. Acesse o sistema novamente.')
    window.location='https://www1.folha.uol.com.br/mundo/2019/03/homenageado-por-bannon-olavo-de-carvalho-diz-desconhecer-ideias-politicas-de-bolsonaro.shtml';
    </script>";
  }*/
