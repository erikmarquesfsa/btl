            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="login" value="erik">
                  ...
                  <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo $placa; ?>" style="border-radius: 3px" required="" class="form-control" name="cp1">
                    </td>

                    <td style="vertical-align: middle;text-align: center">Tipo:</td>
                    <td>
                    <select name="cp3" class="form-control">
                      <option value="<?php echo utf8_encode($tipo);?>"><?php echo utf8_encode($tipo);?></option>
                       <?php
                        $sql = "SELECT *
                        FROM dados_forms
                  ...
                  <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo $chassi; ?>" style="border-radius: 3px" required="" class="form-control" name="cp7">
                    </td>
                    <td style="vertical-align: middle;text-align: center">Marca:</td>
                    <td>
                    <select name="cp4" class="form-control">
                      <option value="<?php echo utf8_encode($marca);?>"><?php echo utf8_encode($marca);?></option>
                      <?php
                        $sql = "SELECT *
                        FROM dados_forms
                        WHERE tipo = 'marca'
                  ...
                  <tr>
                    ...
                    <td>
                    <input type="number" value="<?php echo $renavan; ?>" style="border-radius: 3px" required="" class="form-control" name="cp2">
                    </td> 

                    <td style="vertical-align: middle;text-align: center">Modelo:</td>
                    <td>
                    <input type="text" value="<?php echo $modelo; ?>" style="border-radius: 3px" required="" class="form-control" name="cp5">
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                    <input type="number" value="<?php echo $ano; ?>" style="border-radius: 3px" required="" class="form-control" name="cp6">
                    </td>
                    <td style="vertical-align: middle;text-align: center">Implemento:</td>
                    <td style="vertical-align: middle">
                      <a href="cadImplemento.php?id=<?php echo $id; ?>" style="color:#000;"><i class="fa fa-bus"></i></a>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo $cor; ?>" style="border-radius: 3px" required="" class="form-control" name="cp8">
                    </td>

                    <td style="vertical-align: middle;text-align: center">Km:</td>
                    <td>
                    <input type="text" value="<?php echo $km; ?>" style="border-radius: 3px" required="" class="form-control" name="cp9">
                    </td>
                  </tr>
        ...
        $(function ($) {
            ...
            $('#formulario').on('submit', function () {
               var i = 1;
                ...
                $.post(this.action, {cp1: cp1, cp2: cp2, cp3: cp3, cp4: cp4, cp5: cp5, cp6: cp6, cp7: cp7, cp8: cp8, cp9: cp9, tp: tp, login: login, id: id}, function (resposta) {
