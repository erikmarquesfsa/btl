            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="tp" value="uni_medida">

                  <table class="table" style="box-shadow: 0px 0px 1px #fff;border-radius: 3px;">

                   <tr>
                    <td style="vertical-align: middle;text-align: center">Código:</td>
                    <td colspan="3">
                  ...
                  <tr>
                    <td style="vertical-align: middle;text-align: center">Grandeza:</td>
                    <td colspan="3">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align: middle;text-align: center">Símbolo:</td>
                    <td>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Unidades de Medida Cadastradas
                  <a href="../../exports/uni_medida.php"><img src="../../images/exccel.png" width="20" height="20"></a>
                  </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center">Grandeza</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: center"><?php echo  utf8_encode($dados['codigo']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['grandeza']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['nome']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['simbolo']);?></td> 
        ...
        $(function ($) {
            ...
            $('#formulario').on('submit', function () {
               var i = 1;
                ...
                $.post(this.action, {cp1: cp1, cp2: cp2, cp3: cp3, cp4: cp4, tp: tp, login: login}, function (resposta) {
