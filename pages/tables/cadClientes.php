            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" style="border-radius: 3px" id="cep" onblur="pesquisacep(this.value);" required="" class="form-control" name="cp4">
                    </td>

                    <td style="vertical-align: middle;text-align: center">Estado:</td>
                    <td>
                      <input type="text" style="border-radius: 3px" id="uf" required="" class="form-control" name="cp5">
                    </td>
                  </tr>
                   ...
                   <tr>
                    ...
                    <td>
                      <input type="text" style="border-radius: 3px" id="rua" required="" class="form-control" name="cp6">
                    </td>

                    <td style="vertical-align: middle;text-align: center">Nº:</td>
                    <td>
                      <input type="number" style="border-radius: 3px" required="" class="form-control" name="cp7">
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" style="border-radius: 3px" id="bairro" required="" class="form-control" name="cp8">
                    </td>

                    <td style="vertical-align: middle;text-align: center">Cidade:</td>
                    <td>
                      <input type="text" style="border-radius: 3px" id="cidade" required="" class="form-control" name="cp9">
                    </td>
                  </tr>
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td>
                      <input type="email" style="border-radius: 3px" required="" class="form-control" name="cp12">
                    </td>

                    <td style="vertical-align: middle;text-align: center">E-mail Secundário:</td>
                    <td>
                      <input type="email" style="border-radius: 3px" required="" class="form-control" name="cp13">
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" style="border-radius: 3px" required="" class="form-control" name="cp15">
                    </td>
                  </tr>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Clientes Cadastrados
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th style="text-align: center">Razão Social / Nome</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center"><?php echo  utf8_encode($dados['situacao']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['cnpj']);?></td> 
