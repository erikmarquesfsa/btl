            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="tp" value="cad_tanque">
                  ...
                  <table class="table" style="box-shadow: 0px 0px 1px #fff;border-radius: 3px;">
                    ...
                    <tr>
                      <td style="vertical-align: middle;text-align: center">Capacidade m³:</td>
                      <td colspan="3">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center">Campacidade m³</th>
                        <th>&nbsp;</th>                 
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center"><?php echo  utf8_encode($dados['capacidade']);?></td> 
