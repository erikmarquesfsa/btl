    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            Cadastro de Implementos
            <a href="../../exports/implementos.php"><img src="../../images/exccel.png" width="20" height="20"></a>
            <small>&nbsp;</small>
          </h1>
          <!--<ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="tp" value="cad_implemento">
                  <input type="hidden" name="cp3" value="<?php echo $_GET['id']; ?>">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tanques Cadastrados
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: center"><?php echo  utf8_encode($dados['placa']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['km']);?></td> 
        ...
        $(function ($) {
            ...
            $('#formulario').on('submit', function () {
               var i = 1;
                ...
                $.post(this.action, {cp3:cp3, cp1: cp1, cp2: cp2, tp: tp, login: login}, function (resposta) {
