            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="tp" value="cad_poco">

                  <table class="table" style="box-shadow: 0px 0px 1px #fff;border-radius: 3px;">

                   <tr>
                    <td style="vertical-align: middle;text-align: center">Poço:</td>
                    <td colspan="3">
                  ...
                  <tr>
                    <td style="vertical-align: middle;text-align: center">Vazão Padrão (m³):</td>
                    <td colspan="3">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Poços Cadastrados
                  <a href="../../exports/poco.php"><img src="../../images/exccel.png" width="20" height="20"></a>
                  </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th style="text-align: center">Poço</th> 
                        <th style="text-align: center">Vazão Padrão (m³)</th>
                        <th>&nbsp;</th>   
                        <th>&nbsp;</th>              
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: center"><?php echo  utf8_encode($dados['poco']);?></td> 
                        <td style="text-align: center"><?php echo  utf8_encode($dados['vazao']);?></td> 
