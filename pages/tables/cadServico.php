            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <input type="hidden" name="tp" value="cad_servico">

                  <table class="table" style="box-shadow: 0px 0px 1px #fff;border-radius: 3px;">

                   <tr>
                    <td style="vertical-align: middle;text-align: center">Tipo de Serviço:</td>
                    <td colspan="3">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Serviços Cadastrados
                  <a href="../../exports/servicos.php"><img src="../../images/exccel.png" width="20" height="20"></a>
                  </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: center;vertical-align: middle;"><?php echo  utf8_encode($dados['servico']);?></td> 
